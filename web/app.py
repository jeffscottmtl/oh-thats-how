...
_APP_START = __import__("datetime").datetime.now()
_APP_BUILD = _APP_START.strftime("%b %d %H:%M")  # e.g. "Apr 19 21:30"


@app.get("/api/version")
async def version():
    return JSONResponse({"version": _APP_BUILD, "build": str(int(_APP_START.timestamp()))})
